...
DomainPartitioner::DomainPartitioner(const InputParameters & params)
...
DomainPartitioner::clone() const
{
  return _app.getFactory().clone(*this);
}

void
DomainPartitioner::_do_partition(MeshBase & mesh, const unsigned int /*n*/)
{
